...
| Field | Value                          |
|---|--------------------------------|
| **Title** | update docker compose file     |
| **Date** | 06-05-2026                     |
| **Priority** | Medium |
| **Author** | NH                             |
...
```
my docker compose file has old versions of the container images in it. I want to upgrade to the latest versions. 
I want to use an image of apache kafka (4.0.2) in stead of the conluent image. 
I want remove zookeeper and use KRaft instead. 
and i want to use the latest version of the provectuslab kafka. 
and i need to add the kafka schema registry for later use. I want the confluentinc/cp-schema-registry latest version
```
